...
from mondrianforest_utils import Forest, Param, parser_add_common_options, parser_check_common_options, \
        ...
        get_filename_mf, precompute_minimal, compute_left_right_statistics, split_node, \
    ...
    def grow(self, data, settings, param, cache):
        ...
        while self.grow_nodes:
            ...
            if node_id.budget > split_cost:
                # SPLIT POLICY GOES HERE !!!
                ##############################################################
                if settings.split_policy == (1,1):
                    ...
                    best_split, feat_id_chosen, split_chosen = split_node(node_id, data, param, cache, train_ids, settings)
                    (train_ids_left, train_ids_right, cache_tmp) = best_split
                ##############################################################
...
def get_data_range(data, train_ids):
    ...
    """
    # if len(train_ids) == 0: return (None, None, None, None)
